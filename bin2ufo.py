...
def main(args=None):
    ...
    sound_transit_7 = load_from_txt("sound_transit_7")
    st_7_ufo = create_ufo("sound_transit_7", "out", sound_transit_7, options.format, st_7_info)

    st_12_info = make_attr_dict("Seattle Transit", 12, 8)
    sound_transit_12 = load_from_txt("sound_transit_12")
    st_12_ufo = create_ufo("sound_transit_12", "out", sound_transit_12, options.format, st_12_info)
    st_15_info = make_attr_dict("Seattle Transit", 15, 11)
    sound_transit_15 = load_from_txt("sound_transit_15")
    st_15_ufo = create_ufo("sound_transit_15", "out", sound_transit_15, options.format, st_15_info)
    st_16_info = make_attr_dict("Seattle Transit", 16, 11)
    sound_transit_16 = load_from_txt("sound_transit_16")
    st_16_ufo = create_ufo("sound_transit_16", "out", sound_transit_16, options.format, st_16_info)

    FontProject().run_from_ufos("out/*.ufo", ("otf", "ttf"), output_dir="out")
    make_woff2(["out/sound_transit_7.otf"], "out")
    make_woff2(["out/sound_transit_15.otf"], "out")
